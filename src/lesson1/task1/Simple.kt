...
fun main(args: Array<String>) {
    ...
    println(sec);
    println(numberRevert(765));
    println(accountInThreeYears(100,13));
    println(trackLength(2.0,4.0,4.0,1.0));
}
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg.toDouble() + (min.toDouble() + sec.toDouble() / 60.0) / 60.0) * PI / 180.0
